...
public class SystemMessages {
    ...
    public static final String startUpTitle = "Booting...\n\n\nWelcome to... \n\n\n" +
            ...
            "▀▀▀▀▀▀               ███    ███   ▀        \n" +
            "                \n" +
            "       Version 2.0 created by Alex Black, Andy Han, Anh Ngoc Vu\n\n";
     ...
     */
    public static final String openWithSword = "\tYou could try prying it open with your sword.\n" +
            "\tWould you like to do that?";
    public static final String openedWindow = "\tYou take the sword from its sheath and place its pointed edge on the sill.\n" +
    ...
    public static final String deathFromWindow = "Your pants get caught on the latch, you fall to your death.";
    public static final String rugHungInWindow = "\tYou drape the rug across the window, pinning it with nails, hammering them into the wall with the hilt of your sword.\n" +
            "\tNothing like a little renovation to ease your headache.\n" +
            "\tYou can see things in the room much better now.";
    public static final String seeGlintAtArmoire = "\tYou see a glint of gold in the mirror.\n" +
            "\tThere is something on the desk behind you,\n" +
            "\tthat you couldn't have noticed without looking through the mirror.";
    public static final String openTrapdoor = "\tYour strength allows you to lift the heavy door open\n" +
    ...
    public static final String latrineDip = "\tNo...no...\n" +
            "\tYou're kidding right?\n" +
            "\tOkay, fine.\n" +
            "\tYou dip the parchment in the latrine. It's wet. Are you happy with yourself?\n" +
            "\tThere had to be a better way.";
    public static final String openDoor = "\tYou open the door to see a tall serious Half-Orc standing before you.\n" +
    ...
    public static final String fight = "\tYou feint adjusting your cloak, and instead draw your family sword.\n" +
    ...
    public static final String lockedDoor = "\tThe door is locked, you must have locked it in a drunken stupor.\n" +
            "\tYou will need to find the key to unlock it.\n\tIs this what hell is like?";
    public static final String ignoreDoorKnocks = "\tYou ignore the knocks, even though every ounce of your being wants them to stop.";
    /**
